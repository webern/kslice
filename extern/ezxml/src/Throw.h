...
#ifndef EASYXML_BUG
#define EASYXML_BUG EASYXML_THROW( "this exception is due to a coding error, please report the bug https://github.com/Webern/MusicXML-Class-Library/issues" );
#endif

#ifndef EASYXML_ASSERT
#define EASYXML_ASSERT(expectedTrueStatement)               \
if ( ! (expectedTrueStatement) ) { EASYXML_THROW("assertion failed '" #expectedTrueStatement "'"); }
#endif
