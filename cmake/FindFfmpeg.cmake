...
####### I added this because LIBRARY_DIRS is comming up empty
foreach(LIBNAME in ${FFMPEG_LIBRARIES})
    get_filename_component(DIRNAME ${LIBNAME} DIRECTORY)
    list(APPEND FFMPEG_LIBRARY_DIRS ${DIRNAME})
endforeach(LIBNAME)
