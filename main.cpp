...
int main( int argc, char *argv[] ) {
    return kscore::kslice( argc, argv );
    //    boost::program_options::options_description desc{"Options"};
    //    desc.add_options()( "help", "Help screen" )(
    //        "input", boost::program_options::value<std::string>(), "Input
    //        file" )( "output", boost::program_options::value<std::string>(),
    //        "Output file" )( "x-size", boost::program_options::value<int>(),
    //        "Grid size x" )( "y-size", boost::program_options::value<int>(),
    //        "Grid size y" );
    //
    ...
    //        ".xml";
    //    auto tempPath = boost::lexical_cast<std::string>( tempDir /
    //    tempFilename ); boost::replace_all( tempPath, "\"", "" );
    //
    //    std::string cmd =
    //        R"(ffprobe -select_streams v -i "####INPUTFILE####" -print_format
    //        xml -show_entries frame=pict_type,coded_picture_number > )";
    ...
    //        std::cerr << "parsing of xml doc failed: " << e.what() <<
    //        std::endl; return 1;
    //    } catch ( ... ) {
